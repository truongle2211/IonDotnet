...
{
    internal sealed class IonListLite: IonSequenceLite, IIonList
    {
        public IonListLite(ContainerlessContext containerlessContext, bool isNull) : base(containerlessContext, isNull)
        {
        }

        public IonListLite(IonContainerLite existing, IContext context, bool isStruct) : base(existing, context, isStruct)
        {
        }
